<style scoped>
    ...
    .portal-component__slider-verify.__success .portal-component__slider-verify__bar .at__handle,
    .portal-component__slider-verify.__error .portal-component__slider-verify__bar .at__handle {
        cursor: default;
    }
    ...
    export default {
        ...
        computed: {
            ...
            barProgressWidth() {
                ...
                return (this.sliding.width + 36) + 'px';
        ...
        methods: {
            ...
            slide($event) {
                ...
                let a = $event.x - this.sliding.startEvent.x;

                if ( a < 0 )
                    a = 0;

                else if ( a > 252 )     // 288 - 36
                    a = 252;

                this.svg.slider.elColour.x = this.svgSliderRM + this.svgSliderRW * (a / 252);
        ...
        mounted() {
            ...
            document.addEventListener('mousedown', this.slideStart);
